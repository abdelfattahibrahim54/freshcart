...
export class ProductsComponent implements OnInit {
  ...
  removeCall(id:any){
    ...
    this._CartService. removeProductFromWish(id).subscribe((val)=>{console.log(val.data);

      

       this.wishId = val.data.toString()
      ...
      this.toastr.error('Product removed from wish list', '', {
        timeOut: 3000,
      });
